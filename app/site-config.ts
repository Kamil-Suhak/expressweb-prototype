...
export const dictionaries = {
  en: {
    seo: {
      ...
      description: "Emergency plumbing, leak repairs, and heating installations. 24/7 service with a satisfaction guarantee.",
      keywords: ["Plumber Krakow", "Emergency Plumbing", "Leak Repair", "Heating Installation"],
    },
    hero: {
      title: "Professional Plumbing Services You Can Trust.",
      subtitle: "From leaky faucets to emergency pipe bursts, we provide fast, reliable solutions for your home and business.",
      primaryCTA: "Call Now",
    ...
    servicesHead: {
      title: "Our Services",
      subtitle: "Expert solutions for all your residential and commercial plumbing needs.",
    },
    services: [
      { title: "Emergency Repairs", description: "Available 24/7 for bursts, leaks, and urgent blockages.", icon: Clock },
      { title: "Installation", description: "Professional installation of sinks, toilets, and water heaters.", icon: Wrench },
      { title: "Leak Detection", description: "Advanced tools to find and fix hidden leaks before they cause damage.", icon: Droplets },
      { title: "Insured Work", description: "All our work is fully insured and comes with a 2-year guarantee.", icon: ShieldCheck },
    ],
    pricingHead: {
      title: "Transparent Service Rates",
      subtitle: "Quality work doesn't have to have hidden costs. Here is our standard pricing.",
    },
    pricing: [
    ...
    footerLinks: [
      { title: "Services", links: [{label: "Emergency", href: "#services"}, {label: "Installations", href: "#services"}] },
      { title: "Support", links: [{label: "FAQ", href: "#"}, {label: "Contact", href: "#contact"}] },
    ],
  },
  ...
  pl: {
    seo: {
      ...
      description: "Pogotowie hydrauliczne, naprawa wycieków i montaż instalacji. Serwis 24/7 z gwarancją satysfakcji.",
      keywords: ["Hydraulik Kraków", "Pogotowie hydrauliczne", "Naprawa rur", "Montaż bojlera"],
    },
    hero: {
      title: "Profesjonalne Usługi Hydrauliczne, Którym Możesz Ufać.",
      subtitle: "Od cieknących kranów po pęknięte rury – zapewniamy szybkie i solidne rozwiązania dla Twojego domu i firmy.",
    ...
    servicesHead: {
      title: "Nasze Usługi",
      subtitle: "Eksperckie rozwiązania dla wszystkich Twoich potrzeb hydraulicznych.",
    },
    services: [
      { title: "Pogotowie 24/7", description: "Dostępni o każdej porze przy awariach, przeciekach i zatorach.", icon: Clock },
      { title: "Montaż i Instalacje", description: "Profesjonalny montaż armatury, toalet i podgrzewaczy wody.", icon: Wrench },
      { title: "Wykrywanie Przecieków", description: "Nowoczesne metody lokalizacji ukrytych wycieków.", icon: Droplets },
      { title: "Gwarancja Jakości", description: "Pełne ubezpieczenie i 2 lata gwarancji na wykonane prace.", icon: ShieldCheck },
    ],
    pricingHead: {
      title: "Przejrzyste Stawki",
      subtitle: "Wysoka jakość bez ukrytych kosztów. Poznaj nasze standardowe ceny.",
    },
    pricing: [
    ...
    footerLinks: [
      { title: "Usługi", links: [{label: "Pogotowie", href: "#services"}, {label: "Montaż", href: "#services"}] },
      { title: "Pomoc", links: [{label: "FAQ", href: "#"}, {label: "Kontakt", href: "#contact"}] },
    ],
  }
};
